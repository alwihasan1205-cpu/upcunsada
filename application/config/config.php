...
$dynamic_base_url .= "://".$_SERVER['HTTP_HOST'];
$dynamic_base_url .= str_replace(basename($_SERVER['SCRIPT_NAME']),"",$_SERVER['SCRIPT_NAME']);
$config['base_url'] = $dynamic_base_url;
...
|--------------------------------------------------------------------------
*/
$config['fonnte_token'] = 'raxPgFexw9xu39zmev7d';
